...
df=pd.read_csv('dataset/original1.csv')
...
def signup():
  ...
  if db.users.insert_one(user):
       ...
       sender_email = "pubudu.piyumalmv@gmail.com"
       receiver_email = user["email"]
       password = "sszkdfvxmebxixxc"

       subject = "Welcome to AI Based Health Guiding Application"
       body = """Hi,

                Thank you for registering with AI Based Health Guiding System. We are excited to have you on board!

                Our web application provides personalized health guidance based on the latest AI technology. With our system, you can track your health progress, set goals, and receive customized 
                recommendations to help you achieve optimal health.

                To get started, simply log in to your account and explore the features available to you. If you have any questions or need assistance, please don't hesitate to contact our support team.

                Thank you for choosing AI Based Health Guiding System. We look forward to helping you achieve your health goals.

                Best regards,
                The AI Based Health Guiding System Team"""
...
def getdietplan(filename):
    ...
    with open('./DietPlans.json', 'r') as file:
        data = json.load(file)
